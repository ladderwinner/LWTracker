...
///
/// # Key Mapping:
/// Most properties represent a key defined at: [Tracking HTTP API](https://developer.LW.org/api-reference/tracking-api). Keys that are not supported for now are:
///
...
public struct Event: Codable {
    ...
    /// Event tracking
    /// https://LW.org/docs/event-tracking/
    ...
    /// Campaign tracking
    /// https://LW.org/docs/tracking-campaigns/
    ...
    /// Content tracking
    /// https://LW.org/docs/content-tracking/
    ...
    /// Goal tracking
    /// https://LW.org/docs/tracking-goals-web-analytics/
    let goalId: Int?
    let revenue: Float?

    /// Ecommerce Order tracking
    /// https://LW.org/docs/ecommerce-analytics/#tracking-ecommerce-orders-items-purchased-required
    let orderId: String?
